...
public class daa extends AppCompatActivity {
    ...
    private String dcUrl="https://drive.google.com/drive/folders/1QM_KjJNQo7ZQUNnXpm64Cj7Depq0a04q?usp=drive_link";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        wv = (WebView) findViewById(R.id.wv_daa);
        ...
        wv.loadUrl(dcUrl);
        wv.addJavascriptInterface(new daa.JavaScriptInterface(), "AndroidInterface");
...
//        adView.loadAd(adRequest);
    ...
    private class Client extends WebViewClient {
        ...
        public void onReceivedError(WebView webView, int errorCode, String description, String failingUrl) {
            ...
            AlertDialog alertDialog = new AlertDialog.Builder(daa.this).create();
