...
public class Electromagneticsmod6 extends AppCompatActivity {
    private WebView wv;
    private int fc=0;
    private AdView adView;
    private String dcUrl="https://drive.google.com/drive/folders/1CLw2X1y_mKxDgq7EfC6qGioMb0slqjQE?usp=drive_link";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        getWindow().setFlags(WindowManager.LayoutParams.FLAG_SECURE, WindowManager.LayoutParams.FLAG_SECURE);
        setContentView(R.layout.activity_electromagneticsmod6);
        // initialising the web view
        wv = (WebView) findViewById(R.id.electromagneticsnotes6);
        ...
        adView = findViewById(R.id.webad13);
    ...
    private class Client extends WebViewClient {
        ...
        public void onReceivedError(WebView webView, int errorCode, String description, String failingUrl) {
            ...
            AlertDialog alertDialog = new AlertDialog.Builder(Electromagneticsmod6.this).create();
