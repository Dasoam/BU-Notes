...
//
//public class sem1pyq2 extends AppCompatActivity {
//
//    @Override
//    protected void onCreate(Bundle savedInstanceState) {
//        super.onCreate(savedInstanceState);
//        setContentView(R.layout.activity_sem1pyq2);
//    }
//}
...
public class sem1pyq2 extends AppCompatActivity {
    private WebView wv;
    private int fc=0;
    private String dcUrl="https://drive.google.com/drive/folders/1-M4iwV83veTB6p34vfFXAi03oaS0lr__?usp=drive_link";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        ...
        wv = (WebView) findViewById(R.id.webviewsem1pyq2);
    ...
    private class Client extends WebViewClient {
        ...
        public void onReceivedError(WebView webView, int errorCode, String description, String failingUrl) {
            ...
            AlertDialog alertDialog = new AlertDialog.Builder(sem1pyq2.this).create();
