package com.dhdash.bunotes.year2.sem1;
...
public class ims_activity extends AppCompatActivity {
    private WebView wv;
    //private AdView adView;
    private int fc=0;
    private String dcUrl="https://drive.google.com/drive/folders/1zOwnZk0n8KOEG5K2B46zaa1LS9PS6LlN?usp=drive_link";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        getWindow().setFlags(WindowManager.LayoutParams.FLAG_SECURE, WindowManager.LayoutParams.FLAG_SECURE);
        setContentView(R.layout.activity_imsactivity);
        // initialising the web view
        wv = (WebView) findViewById(R.id.imsnotes);
    ...
    private class Client extends WebViewClient {
        ...
        public void onReceivedError(WebView webView, int errorCode, String description, String failingUrl) {
            ...
            AlertDialog alertDialog = new AlertDialog.Builder(ims_activity.this).create();
