...
public class cpp extends AppCompatActivity {
    ...
    private int fc=0;
    private String dcUrl="https://drive.google.com/drive/folders/1JZVtKJc94dkLhFwR5Ay9k-52ZBRHeTDm?usp=drive_link";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        wv = (WebView) findViewById(R.id.cppnotes);
    ...
    private class Client extends WebViewClient {
        ...
        public void onReceivedError(WebView webView, int errorCode, String description, String failingUrl) {
            ...
            AlertDialog alertDialog = new AlertDialog.Builder(cpp.this).create();
