...
public class register extends AppCompatActivity {
    ...
    public void login2(View view) {
        ...
        && ben10mail.endsWith("@bennett.edu.in") && name.length()!=0 && !course.equals("Select Course") && !year.equals("Select Course Year")){
            ...
            else if (ben10mail.isEmpty() || !ben10mail.endsWith("@bennett.edu.in")){
            bentenmail.setError("Invalid College ID");}
            else if (course.equals("Select Course")) {
                ((TextView)spinner.getSelectedView()).setError("Select course");
            }
            else if (year.equals("Select Course Year")) {
                ((TextView)spinner2.getSelectedView()).setError("Select course year");
            }
