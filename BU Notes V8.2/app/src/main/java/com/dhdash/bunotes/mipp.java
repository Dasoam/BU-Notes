...
public class mipp extends AppCompatActivity {
    private WebView wv;
    private AdView adView;
    private int fc=0;
    private String dcUrl="https://drive.google.com/drive/folders/1QVcwDg38vKj8y-Q_wkLtLUH75_0V6xkY?usp=drive_link";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        getWindow().setFlags(WindowManager.LayoutParams.FLAG_SECURE, WindowManager.LayoutParams.FLAG_SECURE);
        setContentView(R.layout.activity_mipp);
        // initialising the web view
        wv = (WebView) findViewById(R.id.micronotes);
        ...
        adView = findViewById(R.id.webad22);
    ...
    private class Client extends WebViewClient {
        ...
        public void onReceivedError(WebView webView, int errorCode, String description, String failingUrl) {
            ...
            AlertDialog alertDialog = new AlertDialog.Builder(mipp.this).create();
