...
public class linear_algebra extends AppCompatActivity {
    ...
    private String dcUrl="https://drive.google.com/drive/folders/1q_Ga0AkwXALinsTD8eaN5sFUldYDFv80?usp=drive_link";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        wv = (WebView) findViewById(R.id.wv_linear_algebra);
        ...
        wv.loadUrl(dcUrl);
        wv.addJavascriptInterface(new linear_algebra.JavaScriptInterface(), "AndroidInterface");
...
//        adView.loadAd(adRequest);
    ...
    private class Client extends WebViewClient {
        ...
        public void onReceivedError(WebView webView, int errorCode, String description, String failingUrl) {
            ...
            AlertDialog alertDialog = new AlertDialog.Builder(linear_algebra.this).create();
