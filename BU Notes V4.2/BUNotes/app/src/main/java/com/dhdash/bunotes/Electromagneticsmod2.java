...
public class Electromagneticsmod2 extends AppCompatActivity {
    private WebView wv;
    private int fc=0;
    private AdView adView;
    private String dcUrl="https://drive.google.com/drive/folders/1wUO0RHhY3NZu7JFQIiyoTEdm9WnHSQKc?usp=drive_link";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_electromagneticsmod2);
        // initialising the web view
        wv = (WebView) findViewById(R.id.electromagneticenotes2);
        ...
        adView = findViewById(R.id.webad9);
    ...
    private class Client extends WebViewClient {
        ...
        public void onReceivedError(WebView webView, int errorCode, String description, String failingUrl) {
            ...
            AlertDialog alertDialog = new AlertDialog.Builder(Electromagneticsmod2.this).create();
