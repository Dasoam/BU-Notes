...
public class environmentactivity extends AppCompatActivity {
    ...
    private String dcUrl="https://drive.google.com/drive/folders/1WyHx7qo_zjK5GR715TvgqQJ6Cp9RxxWZ?usp=drive_link";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_environmentactivity);
        // initialising the web view
        wv = (WebView) findViewById(R.id.environmentnotes);
        ...
        adView = findViewById(R.id.webad14);
    ...
    private class Client extends WebViewClient {
        ...
        public void onReceivedError(WebView webView, int errorCode, String description, String failingUrl) {
            ...
            AlertDialog alertDialog = new AlertDialog.Builder(environmentactivity.this).create();
