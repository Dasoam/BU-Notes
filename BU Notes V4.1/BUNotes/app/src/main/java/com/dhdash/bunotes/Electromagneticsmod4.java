...
public class Electromagneticsmod4 extends AppCompatActivity {
    private WebView wv;
    private int fc=0;
    private AdView adView;
    private String dcUrl="https://drive.google.com/drive/folders/1GNsjZPW68QxbnjaBxAHoPZHYOwQ5Z0h-?usp=drive_link";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_electromagneticsmod4);
        // initialising the web view
        wv = (WebView) findViewById(R.id.electromagneticsnotes4);
        ...
        adView = findViewById(R.id.webad11);
    ...
    private class Client extends WebViewClient {
        ...
        public void onReceivedError(WebView webView, int errorCode, String description, String failingUrl) {
            ...
            AlertDialog alertDialog = new AlertDialog.Builder(Electromagneticsmod4.this).create();
