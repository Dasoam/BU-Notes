...
public class ECEmod2 extends AppCompatActivity {
    private WebView wv;
    private int fc=0;
    private AdView adView;
    private String dcUrl="https://drive.google.com/drive/folders/14CD3x_A7sslWBouNkLOvFcx4QJwx99Ch?usp=drive_link";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ecemod2);
        // initialising the web view
        wv = (WebView) findViewById(R.id.ecenotes2);
        ...
        wv.clearCache(true);
        wv.clearHistory();
        wv.addJavascriptInterface(new ECEmod2.JavaScriptInterface(), "AndroidInterface");
        ...
        adView = findViewById(R.id.webad6);
    ...
    private class Client extends WebViewClient {
        ...
        public void onReceivedError(WebView webView, int errorCode, String description, String failingUrl) {
            ...
            AlertDialog alertDialog = new AlertDialog.Builder(ECEmod2.this).create();
