...
public class fondaactivity extends AppCompatActivity {
    private WebView wv;
    private int fc=0;
    private AdView adView;
    private String dcUrl="https://drive.google.com/drive/folders/1oZEl2e8Q09GCNYUQzrH45-jNtZLX_xXN?usp=drive_link";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_fondaactivity);
        // initialising the web view
        wv = (WebView) findViewById(R.id.foundationnotes);
        ...
        adView = findViewById(R.id.webad15);
    ...
    private class Client extends WebViewClient {
        ...
        public void onReceivedError(WebView webView, int errorCode, String description, String failingUrl) {
            ...
            AlertDialog alertDialog = new AlertDialog.Builder(fondaactivity.this).create();
