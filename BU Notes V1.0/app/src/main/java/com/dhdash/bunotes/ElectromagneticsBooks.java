...
public class ElectromagneticsBooks extends AppCompatActivity {
    private WebView wv;
    private int fc=0;
    private AdView adView;
    private String dcUrl="https://drive.google.com/drive/folders/1Np0SPDSiUifwYpkOci3D0R-kJfjkE9us?usp=drive_link";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_electromagnetics_books);
        // initialising the web view
        wv = (WebView) findViewById(R.id.webviewelectromagnetics);
        ...
        wv.clearCache(true);
        wv.clearHistory();
        wv.addJavascriptInterface(new ElectromagneticsBooks.JavaScriptInterface(), "AndroidInterface");
        ...
        adView = findViewById(R.id.webad7);
    ...
    private class Client extends WebViewClient {
        ...
        public void onReceivedError(WebView webView, int errorCode, String description, String failingUrl) {
            ...
            AlertDialog alertDialog = new AlertDialog.Builder(ElectromagneticsBooks.this).create();
