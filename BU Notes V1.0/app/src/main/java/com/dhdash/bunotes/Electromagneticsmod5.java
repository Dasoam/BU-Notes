...
public class Electromagneticsmod5 extends AppCompatActivity {
    private WebView wv;
    private int fc=0;
    private AdView adView;
    private String dcUrl="https://drive.google.com/drive/folders/19fnRvEoygG7_nBWHsCCD7YtaTgWxKZSM?usp=drive_link";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_electromagneticsmod5);
        // initialising the web view
        wv = (WebView) findViewById(R.id.electromagneticsnotes5);
        ...
        adView = findViewById(R.id.webad12);
    ...
    private class Client extends WebViewClient {
        ...
        public void onReceivedError(WebView webView, int errorCode, String description, String failingUrl) {
            ...
            AlertDialog alertDialog = new AlertDialog.Builder(Electromagneticsmod5.this).create();
