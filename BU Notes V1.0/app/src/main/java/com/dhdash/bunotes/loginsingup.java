...
public class loginsingup extends AppCompatActivity implements  AdapterView.OnItemSelectedListener {
    ...
    } else if (!spinner.getSelectedItem().toString().equals("CSE")) {
        Toast.makeText(loginsingup.this,"Select Course",Toast.LENGTH_SHORT).show();
    } else if (!spinner2.getSelectedItem().toString().equals("1")) {
        Toast.makeText(loginsingup.this,"Select Year",Toast.LENGTH_SHORT).show();
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            if (ex.equals("com.google.firebase.auth.FirebaseAuthInvalidUserException: There is no user record corresponding to this identifier. The user may have been deleted.")){
                                ...
                                intent.putExtra("Course",spinner.getSelectedItem().toString());
