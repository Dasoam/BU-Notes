...
public class books2y extends AppCompatActivity {
    private WebView wv;
    private AdView adView;
    private int fc=0;
    private String dcUrl="https://drive.google.com/drive/folders/16oiOSrhwHTSHg1Ob68SIRwbnH8YWRP9R?usp=drive_link";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        getWindow().setFlags(WindowManager.LayoutParams.FLAG_SECURE, WindowManager.LayoutParams.FLAG_SECURE);
        setContentView(R.layout.activity_books2y);
        // initialising the web view
        wv = (WebView) findViewById(R.id.webview2books);
        ...
        adView = findViewById(R.id.webad26);
    ...
    private class Client extends WebViewClient {
        ...
        public void onReceivedError(WebView webView, int errorCode, String description, String failingUrl) {
            ...
            AlertDialog alertDialog = new AlertDialog.Builder(books2y.this).create();
