...
public class Calculus extends AppCompatActivity {
    ...
    private int fc=0;
    private String dcUrl="https://drive.google.com/drive/folders/10GBeZvbwM3FIieq-1XuQpJG5Rk8dfRY_?usp=drive_link";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        wv = (WebView) findViewById(R.id.webviewcalculus);
        ...
        wv.clearCache(true);
        wv.clearHistory();
        wv.addJavascriptInterface(new Calculus.JavaScriptInterface(), "AndroidInterface");
        ...
        adView = findViewById(R.id.webad1);
    ...
    private class Client extends WebViewClient {
        ...
        public void onReceivedError(WebView webView, int errorCode, String description, String failingUrl) {
            ...
            AlertDialog alertDialog = new AlertDialog.Builder(Calculus.this).create();
