...
public class Calculusmod2 extends AppCompatActivity {
    private WebView wv;
    private AdView adView;
    private int fc=0;
    private String dcUrl="https://drive.google.com/drive/folders/1kVW1wGIxaoQno1PHKtPDCRlyPz4TSF18?usp=drive_link";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        getWindow().setFlags(WindowManager.LayoutParams.FLAG_SECURE, WindowManager.LayoutParams.FLAG_SECURE);
        setContentView(R.layout.activity_calculusmod2);
        // initialising the web view
        wv = (WebView) findViewById(R.id.calculusnotes2);
        ...
        adView = findViewById(R.id.webad3);
    ...
    private class Client extends WebViewClient {
        ...
        public void onReceivedError(WebView webView, int errorCode, String description, String failingUrl) {
            ...
            AlertDialog alertDialog = new AlertDialog.Builder(Calculusmod2.this).create();
