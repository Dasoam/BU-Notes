...
public class ECEmod1 extends AppCompatActivity {
    private WebView wv;
    private int fc=0;
    private AdView adView;
    private String dcUrl="https://drive.google.com/drive/folders/1euiyuCPRJQttDiSS8kR9LF7Xzc4QanNn?usp=drive_link";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        getWindow().setFlags(WindowManager.LayoutParams.FLAG_SECURE, WindowManager.LayoutParams.FLAG_SECURE);
        setContentView(R.layout.activity_ecemod1);
        // initialising the web view
        wv = (WebView) findViewById(R.id.ecenotes1);
        ...
        wv.clearCache(true);
        wv.clearHistory();
        wv.addJavascriptInterface(new ECEmod1.JavaScriptInterface(), "AndroidInterface");
        ...
        adView = findViewById(R.id.webad5);
    ...
    private class Client extends WebViewClient {
        ...
        public void onReceivedError(WebView webView, int errorCode, String description, String failingUrl) {
            ...
            AlertDialog alertDialog = new AlertDialog.Builder(ECEmod1.this).create();
