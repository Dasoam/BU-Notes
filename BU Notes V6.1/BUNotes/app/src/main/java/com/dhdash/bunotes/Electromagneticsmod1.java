...
public class Electromagneticsmod1 extends AppCompatActivity {
    private WebView wv;
    private int fc=0;
    private AdView adView;
    private String dcUrl="https://drive.google.com/drive/folders/1n24g5wHcG8BE-iA_bpDTKgyPQ6GdeXtM?usp=drive_link";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        getWindow().setFlags(WindowManager.LayoutParams.FLAG_SECURE, WindowManager.LayoutParams.FLAG_SECURE);
        setContentView(R.layout.activity_electromagneticsmod1);
        // initialising the web view
        wv = (WebView) findViewById(R.id.electromagneticsnotes1);
        ...
        wv.clearCache(true);
        wv.clearHistory();
        wv.addJavascriptInterface(new Electromagneticsmod1.JavaScriptInterface(), "AndroidInterface");
        ...
        adView = findViewById(R.id.webad8);
    ...
    private class Client extends WebViewClient {
        ...
        public void onReceivedError(WebView webView, int errorCode, String description, String failingUrl) {
            ...
            AlertDialog alertDialog = new AlertDialog.Builder(Electromagneticsmod1.this).create();
