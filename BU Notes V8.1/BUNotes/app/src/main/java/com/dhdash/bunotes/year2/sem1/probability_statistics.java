...
public class probability_statistics extends AppCompatActivity {
    ...
    private int fc=0;
    private String dcUrl="https://drive.google.com/drive/folders/1V9IgV89UMrXkjTBJi7GICLeraayHmPeK?usp=drive_link";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        wv = (WebView) findViewById(R.id.probnotes);
    ...
    private class Client extends WebViewClient {
        ...
        public void onReceivedError(WebView webView, int errorCode, String description, String failingUrl) {
            ...
            AlertDialog alertDialog = new AlertDialog.Builder(probability_statistics.this).create();
