package com.dhdash.bunotes.year1.sem2;
...
import com.dhdash.bunotes.year1.sem1.Calculusmod1;
...
public class digital_design extends AppCompatActivity {
    private WebView wv;
    private int fc=0;
    //private AdView adView;
    private String dcUrl="https://drive.google.com/drive/folders/1bleK1BeSfQ8hcZKssbZrnJ99qeMbga8W?usp=drive_link";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        getWindow().setFlags(WindowManager.LayoutParams.FLAG_SECURE, WindowManager.LayoutParams.FLAG_SECURE);
        setContentView(R.layout.activity_digital_design);
        // initialising the web view
        wv = (WebView) findViewById(R.id.wv_digital_design);
        ...
        wv.loadUrl(dcUrl);
        wv.addJavascriptInterface(new digital_design.JavaScriptInterface(), "AndroidInterface");
...
//        adView.loadAd(adRequest);
    ...
    private class Client extends WebViewClient {
        ...
        public void onReceivedError(WebView webView, int errorCode, String description, String failingUrl) {
            ...
            AlertDialog alertDialog = new AlertDialog.Builder(digital_design.this).create();
