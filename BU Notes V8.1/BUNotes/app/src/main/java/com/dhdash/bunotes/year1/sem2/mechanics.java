...
public class mechanics extends AppCompatActivity {
    ...
    private String dcUrl="https://drive.google.com/drive/folders/1Lp2YLla9Z4VBiBjYtNSQMvmzBssxodY3?usp=drive_link";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        wv = (WebView) findViewById(R.id.wv_mechanics);
        ...
        wv.loadUrl(dcUrl);
        wv.addJavascriptInterface(new mechanics.JavaScriptInterface(), "AndroidInterface");
...
//        adView.loadAd(adRequest);
    ...
    private class Client extends WebViewClient {
        ...
        public void onReceivedError(WebView webView, int errorCode, String description, String failingUrl) {
            ...
            AlertDialog alertDialog = new AlertDialog.Builder(mechanics.this).create();
