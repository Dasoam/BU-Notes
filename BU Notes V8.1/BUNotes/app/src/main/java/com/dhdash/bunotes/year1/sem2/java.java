...
public class java extends AppCompatActivity {
    ...
    private String dcUrl="https://drive.google.com/drive/folders/1wd5U9CIljwsS55Oe0c-SpgnBYevB_ZMg?usp=drive_link";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        wv = (WebView) findViewById(R.id.wv_java);
        ...
        wv.loadUrl(dcUrl);
        wv.addJavascriptInterface(new java.JavaScriptInterface(), "AndroidInterface");
...
//        adView.loadAd(adRequest);
    ...
    private class Client extends WebViewClient {
        ...
        public void onReceivedError(WebView webView, int errorCode, String description, String failingUrl) {
            ...
            AlertDialog alertDialog = new AlertDialog.Builder(java.this).create();
