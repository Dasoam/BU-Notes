...
public class useraccount extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bundle.putString(FirebaseAnalytics.Param.ITEM_ID, "3"); // Replace with a unique identifier for your activity
        bundle.putString(FirebaseAnalytics.Param.ITEM_NAME, "Useracoount"); // Replace with the name of your activity
    ...
    public void playstore(View view){
        String url="https://play.google.com/store/apps/developer?id=DA+DashTech";
        if (url.isEmpty()){
    ...
    public void lmsopen1(View view){
