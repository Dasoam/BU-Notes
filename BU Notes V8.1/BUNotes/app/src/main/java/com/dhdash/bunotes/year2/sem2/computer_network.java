package com.dhdash.bunotes.year2.sem2;
...
public class computer_network extends AppCompatActivity {
    private WebView wv;
    private int fc=0;
    //private AdView adView;
    private String dcUrl="https://drive.google.com/drive/folders/1qjLMU2KFCydqCcp4fCeLQXieZL_a8gX0?usp=drive_link";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        wv = (WebView) findViewById(R.id.wv_cn);
        ...
        wv.loadUrl(dcUrl);
        wv.addJavascriptInterface(new computer_network.JavaScriptInterface(), "AndroidInterface");
...
//        adView.loadAd(adRequest);
    ...
    private class Client extends WebViewClient {
        ...
        public void onReceivedError(WebView webView, int errorCode, String description, String failingUrl) {
            ...
            AlertDialog alertDialog = new AlertDialog.Builder(computer_network.this).create();
