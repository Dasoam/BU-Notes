...
public class pythonactivity extends AppCompatActivity {
    ...
    private String dcUrl="https://drive.google.com/drive/folders/17zun-KPJ-RSXMnfbf480zdIpuZnEjGkI?usp=drive_link";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        wv = (WebView) findViewById(R.id.pythonnotes);
...
//
//
//        adView = findViewById(R.id.webad18);
...
//        adView.loadAd(adRequest);
    ...
    private class Client extends WebViewClient {
        ...
        public void onReceivedError(WebView webView, int errorCode, String description, String failingUrl) {
            ...
            AlertDialog alertDialog = new AlertDialog.Builder(pythonactivity.this).create();
