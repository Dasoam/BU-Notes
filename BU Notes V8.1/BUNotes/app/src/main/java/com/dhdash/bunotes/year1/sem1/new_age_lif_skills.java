...
public class new_age_lif_skills extends AppCompatActivity {
    private WebView wv;
    private int fc=0;
    //private AdView adView;
    private String dcUrl="https://drive.google.com/drive/folders/1wm9A53qa8X3933Egw-eMto3aufn9KIU5?usp=drive_link";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        wv = (WebView) findViewById(R.id.newagenotes);
    ...
    private class Client extends WebViewClient {
        ...
        public void onReceivedError(WebView webView, int errorCode, String description, String failingUrl) {
            ...
            AlertDialog alertDialog = new AlertDialog.Builder(new_age_lif_skills.this).create();
